...
{{
  ...
  "provider": {{
    ...
    a_tab1, a_tab2 = st.tabs(["🧠 Strategic Cognitive Audit", "🎯 Quadrant Analysis"])
    ...
    with a_tab2:
        ...
        if not df.empty:
            # Fix: Ensure bins cover 0-100 and convert to string for Plotly compatibility
            ...
            with qc2:
                ...
                # Visualization of Difficulty vs AI Visibility
            ...
            st.info("💡 **Decision Engine Tip:** Target the 'Low Difficulty / High AI Score' cluster in the heatmap (usually bottom-right) for the fastest AIO results.")
